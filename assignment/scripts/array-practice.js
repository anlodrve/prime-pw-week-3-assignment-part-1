...
let favoriteFoods = ['guacamole', 'green curry', 'mashed potatoes', 'cheese', 'fried okra']
...
favoriteFoods.unshift('biscuits');
...
favoriteFoods.splice(1,1,"sweet potato");
console.log('Replaced one, now my favorite foods are:', favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
favoriteFoods.sort();
favoriteFoods.reverse();
console.log('These are my favorite foods in reverse alphabetical order:',favoriteFoods);
...
let animalsFoods = animalArray.concat(favoriteFoods);
